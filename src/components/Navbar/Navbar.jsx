...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7x] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shodow-md": "bg-transparent"
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='text-lg font-semibold cursor-pointer '>
          ...
          <span className='text-white'>Madhumita</span>
          <span className='text-[#8245ec]'>/</span>
          <span className='text-white'>Sugandhi</span>
          <span className='text-[#8245ec]'>&gt;</span>
        ...
        <div className='hidden md:flex space-x-4'>
          <a href="https://github.com/madhumitasugandhi"
          target='_blank' 
          ...
          <a href="https://www.linkedin.com/in/madhumita-sugandhi-557aa22a9/"
          target='_blank' 
          rel='noopener noreferre'
          className='text-gray-300 hover:text-[#8245ec]'
          >
